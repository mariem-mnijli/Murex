package tn.stage.spring.registration;
...
import tn.stage.spring.registration.token.ConfirmationToken;
...
import tn.stage.spring.registration.token.ResetPasswordToken;
import tn.stage.spring.repository.AppUserRepository;
import tn.stage.spring.service.AppUserService;
...
public class RegistrationService {
	...
	public String register(RegistrationRequest request) {
		...
		String link="http://localhost:8091/registration/confirm?token="+ token;
		emailSender.send(
				request.getEmail(), 
	 ...
	 public String forgetpassword(String email) {
	       ...
	       // String token ="";
	        ...
	        String link = "http://localhost:8091/registration/forgetpassword"+email;
