...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter  {
	...
	http.authorizeRequests().antMatchers(HttpMethod.GET,"/user/Users").hasAnyAuthority("ADMIN");
	http.authorizeRequests().antMatchers(HttpMethod.GET,"/blacklist/getAllBlacklist").hasAnyAuthority("SUPERADMIN");
